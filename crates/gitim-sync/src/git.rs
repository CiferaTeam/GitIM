...
pub(crate) fn run_git_command_with_env_and_timeout(
    ...
    run_git_command_with_env_and_input_and_timeout(args, current_dir, envs, None, timeout)
}
...
fn run_git_command_with_env_and_input(
    ...
    run_git_command_with_env_and_input_and_timeout(
        args,
        current_dir,
        envs,
        input,
...
fn run_git_command_with_env_and_input_and_timeout(
    args: &[&str],
    current_dir: &Path,
    envs: &[(&str, &str)],
    input: Option<&[u8]>,
