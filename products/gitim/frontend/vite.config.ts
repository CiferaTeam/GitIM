...
export default defineConfig({
  ...
  test: {
    ...
    // Node 25 exposes file-backed Web Storage to workers by default. Vitest
    // provides each test environment's storage, so disable Node's unused
    // implementation when the active runtime supports the flag.
