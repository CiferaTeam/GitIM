import { providerSupportsEffort, type ProviderId } from "@/lib/providers";
...
// editable at all (`canEditModel`); Effort applies to Claude and Codex. Both apply on the
...
export function runningLockedFields(
  ...
  if (providerSupportsEffort(provider)) fields.push("Effort");
  return fields;
}
