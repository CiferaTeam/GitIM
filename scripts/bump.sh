...
要求：
- 标题：# GitIM ${NEXT_TAG}
- 只关心 gitim 的功能本身, 对 products 下面的产品功能不做讨论
...
echo ""
echo "    Next step: git push --follow-tags   # triggers GHA release workflow"
echo "    Fallback:  ./scripts/release.sh      # local cross-compile (slow on macOS)"
